...
AMLOGIC_COMMON_OR_UPGRADE_MODULES = AMLOGIC_UPGRADE_R_MODULES if UPGRADE_PROJECT == "r" or UPGRADE_PROJECT == "R" else \
		 ...
		 AMLOGIC_COMMON_MODULES
AMLOGIC_PROJECT_ALL_MODULES = AMLOGIC_COMMON_OR_UPGRADE_MODULES + AMLOGIC_GKIX_MODULES + MODULES_OUT_ADD + AMLOGIC_ANDROID_MODULES if EXTRA_ANDROID_MODULE else \
	      AMLOGIC_COMMON_OR_UPGRADE_MODULES + AMLOGIC_GKIX_MODULES + MODULES_OUT_ADD
AMLOGIC_UNIQUE_PROJECT_ALL_MODULES = [k for k in {x: None for x in AMLOGIC_PROJECT_ALL_MODULES}]

AMLOGIC_PROJECT_REMOVE_MODULES = \
	MODULES_OUT_REMOVE + AMLOGIC_UPGRADE_R_REMOVE_MODULES if UPGRADE_PROJECT == "r" or UPGRADE_PROJECT == "R" else \
	MODULES_OUT_REMOVE + AMLOGIC_UPGRADE_S_REMOVE_MODULES if UPGRADE_PROJECT == "s" or UPGRADE_PROJECT == "S" else \
	MODULES_OUT_REMOVE + AMLOGIC_UPGRADE_P_REMOVE_MODULES if UPGRADE_PROJECT == "p" or UPGRADE_PROJECT == "P" else \
	MODULES_OUT_REMOVE + AMLOGIC_UPGRADE_U_REMOVE_MODULES if UPGRADE_PROJECT == "u" or UPGRADE_PROJECT == "U" else \
	MODULES_OUT_REMOVE
...
AMLOGIC_MODULES = AMLOGIC_KERNEL_MODULES if DDK_BUILD else AMLOGIC_ALL_MODULES
AMLOGIC_DDK_MODULES = AMLOGIC_ALL_DDK_MODULES if DDK_BUILD else []
