...
static const struct pinctrl_pin_desc meson_c1_periphs_pins[] = {
	MESON_PIN(GPIOD_0),
	MESON_PIN(GPIOD_1),
	MESON_PIN(GPIOD_2),
	MESON_PIN(GPIOD_3),
...
static struct meson_pmx_group meson_c1_periphs_groups[] __initdata = {
	GPIO_GROUP(GPIOD_0),
	GPIO_GROUP(GPIOD_1),
	GPIO_GROUP(GPIOD_2),
	GPIO_GROUP(GPIOD_3),
...
static const char * const pdm_groups[] = {
	"pdm_din0_c", "pdm_din1_c", "pdm_dclk_c", "pdm_dclk_m",
...
static struct meson_pmx_func meson_c1_periphs_functions[] __initdata = {
...
static struct meson_bank meson_c1_periphs_banks[] = {
	...
	BANK_DS("D", GPIOD_0,    GPIOD_12,  0,  12,
	     0x3,   0,  0x4,  0,   0x2,  0,  0x1,  0,  0x0,  0, 0x5, 0),
	BANK_DS("E", GPIOE_0,    GPIOE_1,   13, 14,
	     0x13,  0,  0x14,  0,  0x12, 0,  0x11, 0,  0x10, 0, 0x15, 0),
	BANK_DS("B", GPIOB_0,    GPIOB_13,  15, 28,
	     0x23,  0,  0x24,  0,  0x22, 0,  0x21, 0,  0x20, 0, 0x25, 0),
	BANK_DS("C", GPIOC_0,    GPIOC_7,   29, 36,
	     0x33,  0,  0x34,  0,  0x32, 0,  0x31, 0,  0x30, 0, 0x35, 0),
	BANK_DS("X", GPIOX_0,    GPIOX_19,  37, 56,
	     0x43,  0,  0x44,  0,  0x42, 0,  0x41, 0,  0x40, 0, 0x45, 0),
	BANK_DS("M", GPIOM_0,    GPIOM_15,  57, 72,
...
static struct meson_pinctrl_data meson_c1_periphs_pinctrl_data __refdata = {
	.name		= "periphs-banks",
	.pins		= meson_c1_periphs_pins,
	.groups		= meson_c1_periphs_groups,
	.funcs		= meson_c1_periphs_functions,
	.banks		= meson_c1_periphs_banks,
	.num_pins	= ARRAY_SIZE(meson_c1_periphs_pins),
...
static const struct of_device_id meson_c1_pinctrl_dt_match[] = {
	{
		.compatible = "amlogic,meson-c1-periphs-pinctrl",
		.data = &meson_c1_periphs_pinctrl_data,
	},
	{ },
};

static struct platform_driver meson_c1_pinctrl_driver = {
...
static int __init meson_c1_pinctrl_init(void)
{
	meson_c1_pinctrl_driver.driver.of_match_table =
				meson_c1_pinctrl_dt_match;
	return platform_driver_register(&meson_c1_pinctrl_driver);
}
arch_initcall(meson_c1_pinctrl_init);
