...
#include <dt-bindings/gpio/meson-t6w-gpio.h>
#include "pinctrl-meson.h"
#include "pinctrl-meson-axg-pmx.h"

static const struct pinctrl_pin_desc meson_t6w_analog_pins[] = {
	MESON_PIN(CDAC_IOUT),
	MESON_PIN(CVBS0),
};

static struct meson_pmx_group meson_t6w_analog_groups[] __initdata = {
...
static struct meson_pmx_func meson_t6w_analog_functions[] __initdata = {
...
static struct meson_pinctrl_data meson_t6w_analog_pinctrl_data __refdata = {
	.name		= "analog-banks",
	.pins		= meson_t6w_analog_pins,
	.groups		= meson_t6w_analog_groups,
	.funcs		= meson_t6w_analog_functions,
	.banks		= meson_t6w_analog_banks,
	.num_pins	= ARRAY_SIZE(meson_t6w_analog_pins),
...
static const struct pinctrl_pin_desc meson_t6w_periphs_pins[] = {
	MESON_PIN(GPIOW_0),
	MESON_PIN(GPIOW_1),
	MESON_PIN(GPIOW_2),
	MESON_PIN(GPIOW_3),
...
static struct meson_pmx_group meson_t6w_periphs_groups[] __initdata = {
	/* func0 as GPIO */
	GPIO_GROUP(GPIOW_0),
	GPIO_GROUP(GPIOW_1),
	GPIO_GROUP(GPIOW_2),
...
static struct meson_pmx_func meson_t6w_periphs_functions[] __initdata = {
...
static struct meson_bank meson_t6w_periphs_banks[] = {
	...
	BANK_DS("W",  GPIOW_0, GPIOW_17, 25, 42,
		0x063,  0, 0x064,  0, 0x062,  0, 0x061,  0, 0x060,  0, 0x067,  0),
	BANK_DS("D",  GPIOD_0, GPIOD_14, 43, 57,
		0x003,  0, 0x004,  0, 0x002,  0, 0x001,  0, 0x000,  0, 0x007,  0),
	BANK_DS("E",  GPIOE_0,  GPIOE_1, 58, 59,
	...
	BANK_DS("TEST_N", GPIO_TEST_N, GPIO_TEST_N, 140, 140,
...
static struct meson_pinctrl_data meson_t6w_periphs_pinctrl_data __refdata = {
	.name		= "periphs-banks",
	.pins		= meson_t6w_periphs_pins,
	.groups		= meson_t6w_periphs_groups,
	.funcs		= meson_t6w_periphs_functions,
	.banks		= meson_t6w_periphs_banks,
	.num_pins	= ARRAY_SIZE(meson_t6w_periphs_pins),
...
static const struct of_device_id meson_t6w_pinctrl_dt_match[] = {
	{
		.compatible = "amlogic,meson-t6w-periphs-pinctrl",
		.data = &meson_t6w_periphs_pinctrl_data,
	},
	{
		.compatible = "amlogic,meson-t6w-analog-pinctrl",
		.data = &meson_t6w_analog_pinctrl_data,
	},
	{ },
};

static struct platform_driver meson_t6w_pinctrl_driver = {
...
#ifndef MODULE
static int __init t6w_pmx_init(void)
{
	meson_t6w_pinctrl_driver.driver.of_match_table =
			meson_t6w_pinctrl_dt_match;
	return platform_driver_register(&meson_t6w_pinctrl_driver);
}
arch_initcall(t6w_pmx_init);

#else
int __init meson_t6w_pinctrl_init(void)
{
	meson_t6w_pinctrl_driver.driver.of_match_table =
			meson_t6w_pinctrl_dt_match;
	return platform_driver_register(&meson_t6w_pinctrl_driver);
}
module_init(meson_t6w_pinctrl_init);
#endif
