...
{
	pr_notice("build info: project:%s, build_type:%s, gki_config:%s, gki_image:%s\n",
			BUILD_PROJECT, BUILD_TYPE, GKI_CONFIG, GKI_IMAGE);
	pr_notice("build_time:%s, common_drivers:%s\n", BUILD_TIME, COMMON_DRIVERS_RELEASE);
