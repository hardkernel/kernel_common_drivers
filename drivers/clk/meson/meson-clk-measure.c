...
static struct meson_msr_id clk_msr_g12a[] __initdata = {
	...
	CLK_MSR_ID(108, "audio_locker_in"),
	CLK_MSR_ID(109, "audio_locker_out"),
...
static struct meson_msr_id clk_msr_t6w[] __initdata = {
	CLK_MSR_ID(0, "cts_sys_clk"),
	CLK_MSR_ID(1, "cts_axi_clk"),
	CLK_MSR_ID(2, "cts_rtc_clk"),
	CLK_MSR_ID(3, "vencl_clk"),
	...
	CLK_MSR_ID(57, "lcd_an_clk_ph2"),
	CLK_MSR_ID(58, "lcd_an_clk_ph3"),
	CLK_MSR_ID(59, "cts_dpe_clk"),
	CLK_MSR_ID(60, "cts_vdin_meas_clk"),
	CLK_MSR_ID(61, "cts_vpu_clk"),
	CLK_MSR_ID(63, "cts_dae_clk"),
	CLK_MSR_ID(64, "cts_amfc_clk"),
	CLK_MSR_ID(65, "cts_vid_lock_clk"),
	CLK_MSR_ID(66, "cts_vapbclk"),
	CLK_MSR_ID(67, "cts_ge2d_clk"),
	...
	CLK_MSR_ID(77, "eth_mppll_test"),
	CLK_MSR_ID(79, "demod_TSin_CLK_IN"),
	CLK_MSR_ID(80, "mod_TSin_A_CLK_IN"),
	CLK_MSR_ID(81, "mod_TSin_B_CLK_IN"),
	CLK_MSR_ID(82, "mod_TSin_C_CLK_IN"),
	CLK_MSR_ID(86, "lvds0_fifo_clk"),
	CLK_MSR_ID(87, "cts_spicc_3_clk"),
	CLK_MSR_ID(88, "cts_spicc_2_clk"),
	CLK_MSR_ID(98, "cts_hevcb_clk"),
	CLK_MSR_ID(100, "cts_hdmi_aud_pll_clk"),
	CLK_MSR_ID(101, "cts_hdmi_acr_ref_clk"),
	CLK_MSR_ID(102, "cts_hdmi_meter_clk"),
	...
	CLK_MSR_ID(130, "AU_ADC_CLK_G128X"),
	CLK_MSR_ID(131, "AU_DAC1_CLK_G128X"),
	CLK_MSR_ID(133, "acodec_i2sout_bclk1"),
	CLK_MSR_ID(136, "o_earctx_dmac_clk"),
	CLK_MSR_ID(137, "o_earctx_cmdc_clk"),
	CLK_MSR_ID(138, "earctx_ana_dmac_clk_a2d"),
	CLK_MSR_ID(141, "toacodec_bclk"),
	CLK_MSR_ID(142, "toacodec_mclk"),
	CLK_MSR_ID(144, "audio_spdifout_mst_clk"),
	CLK_MSR_ID(146, "audio_mclk"),
	...
	CLK_MSR_ID(171, "ddrphy_dficlk"),
	CLK_MSR_ID(172, "ddrphy_pclk"),
	CLK_MSR_ID(173, "ts_top_clk"),
	CLK_MSR_ID(174, "dmc_difclk"),
	CLK_MSR_ID(175, "rng_ring_osc_clk[0]"),
	CLK_MSR_ID(176, "rng_ring_osc_clk[1]"),
	CLK_MSR_ID(177, "rng_ring_osc_clk[2]"),
	CLK_MSR_ID(178, "rng_ring_osc_clk[3]"),
	CLK_MSR_ID(179, "rng_ring_osc_clk[4]"),
	CLK_MSR_ID(180, "am_ring_out0"),
	CLK_MSR_ID(181, "am_ring_out1"),
	CLK_MSR_ID(182, "am_ring_out2"),
	CLK_MSR_ID(183, "am_ring_out3"),
	...
	CLK_MSR_ID(219, "cts_enc0_if_clk"),
	CLK_MSR_ID(222, "cts_enc0_clk"),
	CLK_MSR_ID(223, "am_ring_osc_clk_out[33]"),
	CLK_MSR_ID(224, "tvfe_sample_clk"),
	CLK_MSR_ID(225, "spclk"),
	CLK_MSR_ID(226, "sar_adc_clk_o"),
	CLK_MSR_ID(227, "jtag_tck_i_pad"),
	...
	CLK_MSR_ID(246, "alocker_in_clk"),
	CLK_MSR_ID(247, "resamplec_clk"),
	CLK_MSR_ID(249, "ts_cpu_clk"),
};

static struct meson_msr_id clk_msr_t6x[] __initdata = {
	CLK_MSR_ID(0, "cts_sys_clk"),
	CLK_MSR_ID(1, "cts_axi_clk"),
	CLK_MSR_ID(2, "cts_rtc_clk"),
	CLK_MSR_ID(3, "vencl_clk"),
	...
	CLK_MSR_ID(5, "mali_aclkm_tm"),
	CLK_MSR_ID(6, "sys_cpu_clk_div16"),
	CLK_MSR_ID(7, "fclk_div2p5"),
	CLK_MSR_ID(8, "cts_cecb_clk"),
	CLK_MSR_ID(9, "hrx21_clk18t_fpll[0]"),
	CLK_MSR_ID(10, "fclk_div5"),
	CLK_MSR_ID(11, "fclk_div7"),
	CLK_MSR_ID(13, "hrx21_clk18t_fpll[1]"),
	CLK_MSR_ID(14, "ddr0_dpll_pt_clk"),
	CLK_MSR_ID(15, "ddr1_dpll_pt_clk"),
	CLK_MSR_ID(16, "mpll_clk_50m"),
	CLK_MSR_ID(17, "hx21_clk_test[0]"),
	CLK_MSR_ID(18, "hifi1_pll_clk"),
	CLK_MSR_ID(19, "hifi_pll_clk"),
	CLK_MSR_ID(20, "gp0_pll_clk"),
	CLK_MSR_ID(21, "gp1_pll_clk"),
	CLK_MSR_ID(22, "eth_mppll_50m_ckout"),
	CLK_MSR_ID(23, "sys_pll_div16"),
	CLK_MSR_ID(24, "ddr1_deskew_pll_test_clk"),
	CLK_MSR_ID(25, "gp2_pll_clk"),
	CLK_MSR_ID(26, "hx21_clk_test[1]"),
	CLK_MSR_ID(27, "hx21_cdr0_clk_clk[0]"),
	CLK_MSR_ID(28, "hx21_cdr0_clk_clk[1]"),
	CLK_MSR_ID(29, "ddr0_deskew_pll_test_clk"),
	CLK_MSR_ID(30, "mod_eth_phy_ref_clk"),
	CLK_MSR_ID(31, "mod_eth_tx_clk"),
	CLK_MSR_ID(32, "cts_eth_clk125Mhz"),
	...
	CLK_MSR_ID(39, "eth_phy_plltxclk"),
	CLK_MSR_ID(40, "ephy_test_clk"),
	CLK_MSR_ID(41, "hrx20_pll_clk_test[0]"),
	CLK_MSR_ID(42, "hdmirx_pll_clk"),
	CLK_MSR_ID(45, "hrx20_pll_clk_test[1]"),
	CLK_MSR_ID(46, "hdmirx_5m_clk"),
	CLK_MSR_ID(47, "hdmirx_2m_clk"),
	CLK_MSR_ID(48, "hdmirx_cfg_clk"),
	CLK_MSR_ID(49, "cts_hdmirx_hdcp2x_eclk"),
	...
	CLK_MSR_ID(68, "hdmirx_aud_pll_clk"),
	CLK_MSR_ID(69, "hdmirx_aud_sck"),
	CLK_MSR_ID(70, "hrx21_cable_clk[0]"),
	CLK_MSR_ID(71, "hrx21_cable_clk[1]"),
	CLK_MSR_ID(72, "hrx20_cable_clk[0]"),
	CLK_MSR_ID(73, "hrx20_cable_clk[1]"),
	CLK_MSR_ID(75, "cts_cdac_clk_c"),
	CLK_MSR_ID(77, "eth_mppll_test"),
	CLK_MSR_ID(79, "demod_TSin_CLK_IN"),
	CLK_MSR_ID(80, "mod_TSin_A_CLK_IN"),
	...
	CLK_MSR_ID(87, "cts_spicc_3_clk"),
	CLK_MSR_ID(88, "cts_spicc_2_clk"),
	CLK_MSR_ID(89, "hrx21_tmds20_clk[0]"),
	CLK_MSR_ID(90, "hrx21_tmds20_clk[1]"),
	CLK_MSR_ID(91, "hrx20_tmds20_clk[0]"),
	CLK_MSR_ID(92, "hrx20_tmds20_clk[1]"),
	CLK_MSR_ID(93, "hrx21_tmds21_clk[0]"),
	CLK_MSR_ID(94, "hrx21_tmds21_clk[1]"),
	CLK_MSR_ID(95, "hrx21_pixl21_clk[0]"),
	CLK_MSR_ID(96, "hrx21_pixl21_clk[1]"),
	CLK_MSR_ID(97, "cts_hcodec_clk"),
	CLK_MSR_ID(98, "cts_hevcb_clk"),
	CLK_MSR_ID(100, "cts_hdmi_aud_pll_clk"),
	CLK_MSR_ID(101, "cts_hdmi_acr_ref_clk"),
	...
	CLK_MSR_ID(103, "hdmi_vid_clk"),
	CLK_MSR_ID(104, "hdmi_aud_clk"),
	CLK_MSR_ID(105, "dmc_dficlk"),
	CLK_MSR_ID(106, "ddrphy_dficlk"),
	CLK_MSR_ID(107, "ddrphy_pclk"),
	CLK_MSR_ID(108, "hrx21_clk_audpll[0]"),
	CLK_MSR_ID(109, "hrx21_clk_audpll[1]"),
	CLK_MSR_ID(110, "cts_sc_clk"),
	CLK_MSR_ID(111, "cts_sar_adc_clk"),
	CLK_MSR_ID(112, "hdmirx_dcp_clk"),
	CLK_MSR_ID(113, "cts_sd_emmc_C_clk(nand)"),
	CLK_MSR_ID(116, "i_gpio_msr"),
	CLK_MSR_ID(117, "cts_spicc_1_clk"),
	CLK_MSR_ID(118, "cts_spicc_0_clk"),
	CLK_MSR_ID(119, "cts_tcon_pll_clk"),
	CLK_MSR_ID(121, "cts_ts_clk(temp sensor)"),
	CLK_MSR_ID(122, "cts_usb2_48m_clk"),
	CLK_MSR_ID(123, "cts_bcon_clk"),
	CLK_MSR_ID(124, "cts_usb3_250m_clk"),
	CLK_MSR_ID(125, "adc_dpll_intclk"),
	CLK_MSR_ID(126, "adc_extclk_in"),
	CLK_MSR_ID(127, "cts_demod_32k_clk"),
	CLK_MSR_ID(128, "cts_demod_core_t2_clk"),
	...
	CLK_MSR_ID(130, "AU_ADC_CLK_G128X"),
	CLK_MSR_ID(131, "AU_DAC1_CLK_G128X"),
	CLK_MSR_ID(133, "acodec_toaudio_dac_bclk"),
	CLK_MSR_ID(136, "o_earctx_dmax_clk"),
	CLK_MSR_ID(137, "o_earctx_cmdc_clk"),
	CLK_MSR_ID(138, "earctx_ana_dmac_clk"),
	CLK_MSR_ID(141, "toacodec_bclk"),
	CLK_MSR_ID(142, "toacodec_mclk"),
	CLK_MSR_ID(144, "o_spdifout_mst_clk"),
	CLK_MSR_ID(145, "o_spdifin_mst_clk"),
	CLK_MSR_ID(146, "o_mclk"),
	CLK_MSR_ID(147, "o_vad_clk"),
	CLK_MSR_ID(148, "o_tdmout_d_sclk"),
	CLK_MSR_ID(149, "o_tdmout_c_sclk"),
	CLK_MSR_ID(150, "atv_dmd_mono_clk_32"),
	CLK_MSR_ID(151, "atv_dmd_i2s_sclk"),
	CLK_MSR_ID(152, "adec_i2s_sclk"),
	CLK_MSR_ID(153, "acodec_toaudio_adc_bclk"),
	CLK_MSR_ID(154, "au_adc_clk_to_gpio"),
	CLK_MSR_ID(155, "au_dac1_clk_to_gpio"),
	CLK_MSR_ID(156, "cts_pwm_j_clk"),
	CLK_MSR_ID(157, "cts_pwm_i_clk"),
	CLK_MSR_ID(158, "cts_pwm_h_clk"),
	CLK_MSR_ID(159, "cts_pwm_g_clk"),
	CLK_MSR_ID(160, "p20_usb2_ckout"),
	CLK_MSR_ID(161, "u3drd_pipi_pclk"),
	CLK_MSR_ID(162, "p22_usb2_ckout"),
	CLK_MSR_ID(163, "p21_usb2_ckout"),
	CLK_MSR_ID(164, "cts_pwm_f_clk"),
	CLK_MSR_ID(165, "cts_pwm_e_clk"),
	...
	CLK_MSR_ID(169, "cts_pwm_a_clk"),
	CLK_MSR_ID(170, "cts_ACLKM"),
	CLK_MSR_ID(171, "u3drd_upctx_clk_sync_b20"),
	CLK_MSR_ID(172, "u3drd_upcrx_cdrclk"),
	CLK_MSR_ID(173, "ts_vpu_clk"),
	CLK_MSR_ID(174, "u3drd_upcrxpll_clk_test"),
	CLK_MSR_ID(175, "rng_ring_0"),
	CLK_MSR_ID(176, "rng_ring_1"),
	CLK_MSR_ID(177, "rng_ring_2"),
	CLK_MSR_ID(178, "rng_ring_3"),
	CLK_MSR_ID(179, "rng_ring_4"),
	CLK_MSR_ID(180, "am_ring_out0"),
	CLK_MSR_ID(181, "am_ring_out1"),
	CLK_MSR_ID(185, "am_ring_out5"),
	CLK_MSR_ID(187, "am_ring_out7"),
	...
	CLK_MSR_ID(203, "cts_tsin_deglitch_clk"),
	CLK_MSR_ID(219, "cts_enc0_if_clk"),
	CLK_MSR_ID(220, "u3drd_upcrxpll_fst_pll_clk"),
	CLK_MSR_ID(221, "dsc_pix_pll_clk"),
	CLK_MSR_ID(222, "cts_enc0_clk"),
	CLK_MSR_ID(224, "tvfe_sample_clk"),
	CLK_MSR_ID(225, "spclk"),
	CLK_MSR_ID(226, "sar_adc_clk_o"),
	CLK_MSR_ID(227, "jtag_tck_i_pad"),
	CLK_MSR_ID(228, "dac_ck0"),
	CLK_MSR_ID(229, "o_tdmout_b_sclk"),
	CLK_MSR_ID(230, "o_tdmout_a_sclk"),
	CLK_MSR_ID(231, "o_tdminb_lb_sclk"),
	CLK_MSR_ID(232, "o_tdmin_lb_sclk"),
	CLK_MSR_ID(233, "o_tdmin_d_sclk"),
	CLK_MSR_ID(234, "o_tdmin_c_sclk"),
	CLK_MSR_ID(235, "o_tdmin_b_sclk"),
	CLK_MSR_ID(236, "o_tdmin_a_sclk"),
	CLK_MSR_ID(237, "o_resampleb_clk"),
	CLK_MSR_ID(238, "o_resamplea_clk"),
	CLK_MSR_ID(239, "o_pdmb_sysclk"),
	CLK_MSR_ID(240, "o_pdmb_dclk"),
	CLK_MSR_ID(241, "o_pdm_sysclk"),
	CLK_MSR_ID(242, "o_pdm_dclk"),
	CLK_MSR_ID(243, "c_alockerb_out_clk"),
	CLK_MSR_ID(244, "c_alockerb_in_clk"),
	CLK_MSR_ID(245, "c_alocker_out_clk"),
	CLK_MSR_ID(246, "c_alocker_in_clk"),
	CLK_MSR_ID(247, "o_resamplec_clk"),
	CLK_MSR_ID(250, "audio_toacodec_adc_bclk"),
	CLK_MSR_ID(251, "audio_toacodec_adc_mclk"),
	CLK_MSR_ID(252, "cts_dsc_pix_clk_sel"),
	CLK_MSR_ID(253, "cts_dsc_pix_clk"),
	CLK_MSR_ID(254, "coresight_clk"),
};
#endif
...
static struct meson_msr_data meson_t6w_data __initdata = {
	.msr_table = (struct meson_msr_id *)&clk_msr_t6w,
	.table_size = ARRAY_SIZE(clk_msr_t6w),
	.duty_offset = (0x6 * 4),
	.reg0_offset = 0x0,
	.reg1_offset = 0x4,
	.reg2_offset = 0x8,
...
static struct meson_msr_data meson_t6x_data __initdata = {
	.msr_table = (struct meson_msr_id *)&clk_msr_t6x,
	.table_size = ARRAY_SIZE(clk_msr_t6x),
	.duty_offset = (0x6 * 4),
	.reg0_offset = 0x0,
	.reg1_offset = 0x4,
	.reg2_offset = 0x8,
...
static const struct of_device_id meson_msr_match_table[] = {
	...
	{
		.compatible = "amlogic,meson-t6w-clk-measure",
		.data = &meson_t6w_data,
	},
	{
		.compatible = "amlogic,meson-t6x-clk-measure",
		.data = &meson_t6x_data,
	},
#endif
	{ /* sentinel */ }
