...
#include "s7.h"
#include <dt-bindings/clock/amlogic,s7-clkc.h>
...
static const struct pll_params_table gp0_pll_table[] = {
	PLL_PARAMS_OD(256, 1, 1), /* DCO = 3072M OD = 4 PLL = 1536M */
...
static struct clk_regmap hifi_pll = {
	.data = &(struct meson_clk_pll_data) {
		...
		.frac = {
			.reg_off = ANACTRL_HIFI0PLL_CTRL2,
			.shift   = 0,
			.width   = 17,
		},
		.od = {
...
static struct clk_regmap video1_div1 = {
	.data = &(struct clk_regmap_gate_data) {
		.offset = CLKCTRL_VIID_CLK_CTRL,
		.bit_idx = 0,
	},
...
static struct clk_regmap video1_div2_gate = {
	.data = &(struct clk_regmap_gate_data) {
		.offset = CLKCTRL_VIID_CLK_CTRL,
		.bit_idx = 1,
	},
	.hw.init = &(struct clk_init_data) {
		.name = "video1_div2_gate",
		.ops = &clk_regmap_gate_ops,
		.parent_hws = (const struct clk_hw *[]) {
			&video_src1.hw,
		},
...
static struct clk_fixed_factor video1_div2 = {
	.mult = 1,
	.div = 2,
	.hw.init = &(struct clk_init_data) {
		.name = "video1_div2",
...
static struct clk_regmap video1_div4_gate = {
	.data = &(struct clk_regmap_gate_data) {
		.offset = CLKCTRL_VIID_CLK_CTRL,
		.bit_idx = 2,
	},
	.hw.init = &(struct clk_init_data) {
		.name = "video1_div4_gate",
		.ops = &clk_regmap_gate_ops,
		.parent_hws = (const struct clk_hw *[]) {
			&video_src1.hw,
		},
...
static struct clk_fixed_factor video1_div4 = {
	.mult = 1,
	.div = 4,
	.hw.init = &(struct clk_init_data) {
		.name = "video1_div4",
...
static struct clk_regmap video1_div6_gate = {
	.data = &(struct clk_regmap_gate_data) {
		.offset = CLKCTRL_VIID_CLK_CTRL,
		.bit_idx = 3,
	},
	.hw.init = &(struct clk_init_data) {
		.name = "video1_div6_gate",
		.ops = &clk_regmap_gate_ops,
		.parent_hws = (const struct clk_hw *[]) {
			&video_src1.hw,
		},
...
static struct clk_fixed_factor video1_div6 = {
	.mult = 1,
	.div = 6,
	.hw.init = &(struct clk_init_data) {
		.name = "video1_div6",
...
static struct clk_regmap video1_div12_gate = {
	.data = &(struct clk_regmap_gate_data) {
		.offset = CLKCTRL_VIID_CLK_CTRL,
		.bit_idx = 4,
	},
	.hw.init = &(struct clk_init_data) {
		.name = "video1_div12_gate",
		.ops = &clk_regmap_gate_ops,
		.parent_hws = (const struct clk_hw *[]) {
			&video_src1.hw,
		},
...
static struct clk_fixed_factor video1_div12 = {
	.mult = 1,
	.div = 12,
	.hw.init = &(struct clk_init_data) {
		.name = "video1_div12",
...
static struct clk_hw *s7_hw_clks[] = {
	...
	[CLKID_VIDEO1_DIV1]           = &video1_div1.hw,
	[CLKID_VIDEO1_DIV2_GATE]      = &video1_div2_gate.hw,
	[CLKID_VIDEO1_DIV2]           = &video1_div2.hw,
	[CLKID_VIDEO1_DIV4_GATE]      = &video1_div4_gate.hw,
	[CLKID_VIDEO1_DIV4]           = &video1_div4.hw,
	[CLKID_VIDEO1_DIV6_GATE]      = &video1_div6_gate.hw,
	[CLKID_VIDEO1_DIV6]           = &video1_div6.hw,
	[CLKID_VIDEO1_DIV12_GATE]     = &video1_div12_gate.hw,
	[CLKID_VIDEO1_DIV12]          = &video1_div12.hw,
...
static const struct meson_clk_hw_data s7_clks = {
	.hws = s7_hw_clks,
