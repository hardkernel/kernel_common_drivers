...
static const struct pll_params_table t7_gp0_pll_table[] = {
	...
	PLL_PARAMS_OD(192, 1, 2), /* DCO = 2304M OD = 1 PLL = 1152M */
	{ /* sentinel */  }
};
...
static const struct pll_params_table t7_gp1_pll_table[] = {
	PLL_PARAMS_OD(100, 1, 1), /*DCO=4800M OD=1200M*/
...
static const struct pll_params_table t7_mclk_pll_table[] = {
	PLL_PARAMS_OD(99, 1, 1), /* DCO = 2376M OD = 1 PLL = 1152M */
	PLL_PARAMS_OD(100, 1, 1), /* DCO = 2400M */
	{ /* sentinel */  }
};
...
static struct clk_regmap t7_mclk_pll_div = {
...
/* cts_vdec_clk */
static const struct clk_parent_data t7_dec_parent_data[] = {
	{ .fw_name = "fdiv2p5", },
	{ .fw_name = "fdiv3", },
	{ .fw_name = "fdiv4", },
	{ .fw_name = "fdiv5", },
...
static struct clk_regmap t7_vdec_p0_mux = {
	...
	.hw.init = &(struct clk_init_data) {
		.name = "vdec_p0_mux",
		.ops = &clk_regmap_mux_ops,
		.parent_data = t7_dec_parent_data,
		.num_parents = ARRAY_SIZE(t7_dec_parent_data),
		.flags = CLK_GET_RATE_NOCACHE,
	},
};
...
static const struct clk_parent_data t7_vpu_clkb_tmp_parent_data[] = {
	{ .hw = &t7_vpu.hw },
	{ .fw_name = "fdiv4", },
	{ .fw_name = "fdiv5", },
	{ .fw_name = "fdiv7", }
...
static struct clk_regmap t7_vpu_clkb_tmp_mux = {
	...
	.hw.init = &(struct clk_init_data) {
		...
		.ops = &clk_regmap_mux_ops,
		.parent_data = t7_vpu_clkb_tmp_parent_data,
		.num_parents = ARRAY_SIZE(t7_vpu_clkb_tmp_parent_data),
		.flags = CLK_GET_RATE_NOCACHE,
	},
};
...
static struct clk_regmap t7_vpu_clkc_p0_mux  = {
	...
	.hw.init = &(struct clk_init_data) {
		...
		.ops = &clk_regmap_mux_ops,
		.parent_data = t7_vpu_clkc_parent_data,
		.num_parents = ARRAY_SIZE(t7_vpu_clkc_parent_data),
		.flags = CLK_GET_RATE_NOCACHE,
	},
};
...
static const struct clk_parent_data t7_spicc_parent_data[] = {
	{ .fw_name = "xtal", },
	{ .fw_name = "sys", },
	{ .fw_name = "fdiv4", },
	{ .fw_name = "fdiv3", },
...
static struct clk_regmap t7_spicc0_mux = {
	...
	.hw.init = &(struct clk_init_data) {
		.name = "spicc0_mux",
		.ops = &clk_regmap_mux_ops,
		.parent_data = t7_spicc_parent_data,
		.num_parents = ARRAY_SIZE(t7_spicc_parent_data),
	},
};
...
struct clk_regmap _name = {						\
	...
	.hw.init = &(struct clk_init_data) {				\
		.name = #_name,						\
		.ops = &clk_regmap_gate_ops,				\
		.parent_data = &t7_sys_pclk_parents,			\
		.num_parents = 1,					\
		.flags = CLK_IGNORE_UNUSED,				\
	},								\
}
...
static struct clk_hw_onecell_data t7_hw_onecell_data = {
	.hws = {
		...
		[CLKID_MCLK_PLL_DIV]		= &t7_mclk_pll_div.hw,
...
static int meson_t7_probe(struct platform_device *pdev)
{
	...
	mclk_data = t7_mclk_pll.data;
	if (ignore_pll_init)
		mclk_data->flags |= CLK_MESON_PLL_NOINIT_ENABLED;
