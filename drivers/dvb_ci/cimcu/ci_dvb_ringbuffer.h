...
/*
 *
 * ci_dvb_ringbuffer.h: ring buffer implementation for the dvb driver
 *
...
#ifndef _CI_DVB_RINGBUFFER_H_
#define _CI_DVB_RINGBUFFER_H_
 ...
 */
void ci_dvb_ringbuffer_init(struct dvb_ringbuffer *rbuf, void *data,
				size_t len);
 ...
 */
ssize_t ci_dvb_ringbuffer_read_user(struct dvb_ringbuffer *rbuf,
 ...
 * Return: number of bytes transferred or -EFAULT
 */
void ci_dvb_ringbuffer_read(struct dvb_ringbuffer *rbuf,
				   u8 *buf, size_t len);
 ...
 * return: number of bytes transferred or -EFAULT
 */
ssize_t ci_dvb_ringbuffer_write(struct dvb_ringbuffer *rbuf, const u8 *buf,
				    size_t len);
 ...
 */
ssize_t ci_dvb_ringbuffer_pkt_write(struct dvb_ringbuffer *rbuf, u8 *buf,
					size_t len);
 ...
 */
ssize_t ci_dvb_ringbuffer_pkt_read_user(struct dvb_ringbuffer *rbuf,
					    size_t idx,
 ...
 */
ssize_t ci_dvb_ringbuffer_pkt_next(struct dvb_ringbuffer *rbuf,
				       size_t idx, size_t *pktlen);

#endif /* _CI_DVB_RINGBUFFER_H_ */
