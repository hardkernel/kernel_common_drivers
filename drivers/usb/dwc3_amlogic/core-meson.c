...
void dwc3_enable_susphy(struct aml_dwc3 *dwc, bool enable)
{
	u32 reg;
	int i;
 ...
 */
static void dwc3_ref_clk_period(struct aml_dwc3 *dwc)
{
 ...
 */
static int dwc3_alloc_event_buffers(struct aml_dwc3 *dwc, unsigned int length)
{
	struct aml_dwc3_event_buffer *evt;
	unsigned int hw_mode;
...
static void dwc3_config_soc_bus(struct aml_dwc3 *dwc)
{
...
static int dwc3_ss_phy_setup(struct aml_dwc3 *dwc, int index)
{
	u32 reg;
...
static int dwc3_hs_phy_setup(struct aml_dwc3 *dwc, int index)
{
	u32 reg;
...
static void dwc3_phy_exit(struct aml_dwc3 *dwc)
{
	int i;
...
static int dwc3_phy_power_on(struct aml_dwc3 *dwc)
{
	int ret;
	int i;
	int j;
...
static void dwc3_phy_power_off(struct aml_dwc3 *dwc)
{
	int i;
...
static int dwc3_clk_enable(struct aml_dwc3 *dwc)
{
	int ret;
...
static void dwc3_clk_disable(struct aml_dwc3 *dwc)
{
...
static void dwc3_config_threshold(struct aml_dwc3 *dwc)
{
	u32 reg;
	u8 rx_thr_num;
	u8 rx_maxburst;
...
static void dwc3_get_software_properties(struct aml_dwc3 *dwc)
{
...
static int dwc3_get_clocks(struct aml_dwc3 *dwc)
{
	struct device *dev = dwc->dev;
...
static int dwc3_get_num_ports(struct aml_dwc3 *dwc)
{
	void __iomem *base;
	u8 major_revision;
	u32 offset;
