...
static ssize_t uuid_show(const struct class *cla, const struct class_attribute *attr, char *buf)
{
	char uuid[UUID_SIZE];
	int ret;
...
static ssize_t mac_show(const struct class *cla, const struct class_attribute *attr, char *buf)
{
	char uuid[UUID_SIZE];
	int ret;
