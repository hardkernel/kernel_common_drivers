 ...
 * @got_first_event:   True, if a CSFFW timeline session has been enabled
 *                     and the first event was received.
 * @is_active:         True, if a CSFFW timeline session has been enabled.
...
/**
 * kbase_csf_tl_reader_init() - Initialize CSFFW Timeline Stream Reader.
 *
...
/**
 * kbase_csf_tl_reader_term() - Terminate CSFFW Timeline Stream Reader.
 *
 * @self:	CSFFW TL Reader instance.
 */
...
/**
 * kbase_csf_tl_reader_debugfs_init() - Initialize debugfs for CSFFW Timeline Stream Reader.
 *
 * @kbdev:	Kbase device.
 */
