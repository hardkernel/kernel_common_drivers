 ...
 *
 * On successful mapping, the VA region and the gpu_alloc recounts will be
 ...
 *
 * On successful unmapping, the VA region and the gpu_alloc recounts will
