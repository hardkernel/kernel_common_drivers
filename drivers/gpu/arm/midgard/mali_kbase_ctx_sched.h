 ...
 *
 * The context is recounted as being busy to prevent it from scheduling
 ...
 *   internally.
 *
 * Return: a valid struct kbase_context on success, which has been recounted
