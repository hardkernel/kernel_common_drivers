 ...
 * * Or, it must have been recounted with a call to kbase_va_region_alloc_get(), and the region
 ...
 * because the pages here are recounted to prevent freeing (and hence reuse
 * elsewhere in the system) until a kbase_vunmap()
 *
