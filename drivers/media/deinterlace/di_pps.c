...
__module_param_named(di_vert_scaler_filter, vert_scaler_filter, uint, 0664);

static unsigned int vert_chroma_scaler_filter = 0xff;
__module_param_named(di_vert_chroma_scaler_filter, vert_chroma_scaler_filter,
		   uint, 0664);
...
__module_param_named(di_pre_scaler_en, pre_scaler_en, bool, 0664);
#endif
