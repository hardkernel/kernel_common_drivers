...
/*Internal functions*/
static void _get_vpp_in_size(unsigned int *height, unsigned int *width)
{
	unsigned int addr = 0;
...
/*External functions*/
int vpp_module_meter_init(struct vpp_dev_s *dev)
{
	int i = 0;
...
void vpp_module_meter_hist_on_vs(void)
{
	unsigned int addr = 0;
	enum io_mode_e io_mode = EN_MODE_DIR;
