...
struct lc_vd_info_s {
	unsigned int vd1_dout_hsize;
	unsigned int vd1_dout_vsize;
	unsigned int vd1_in_hsize;
	unsigned int vd1_in_vsize;
};

struct lc_vs_param_s {
	unsigned int vf_type;
	unsigned int vf_signal_type;
	unsigned int vf_source_type;
	...
	unsigned int skip_proc;
	struct lc_vd_info_s vd_info;
};
...
void vpp_module_lc_on_vs(unsigned short *data_hist, struct lc_vs_param_s *vs_param);
