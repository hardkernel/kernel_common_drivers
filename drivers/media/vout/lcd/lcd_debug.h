...
static unsigned int lcd_reg_dump_encl_a4[] = {
	VPU_VOUT_BLEND_CTRL + 0x300,
	VPU_VOUT_BLEND_DUMDATA + 0x300,
	VPU_VOUT_CORE_CTRL + 0x300,
	VPU_VOUT_INT_CTRL + 0x300,
	VPU_VOUT_DETH_CTRL + 0x300,
	VPU_VOUT_DTH_DATA + 0x300,
	VPU_VOUT_DTH_ADDR + 0x300,
	VPU_VOUT_HS_POS + 0x300,
	VPU_VOUT_VSLN_E_POS + 0x300,
	VPU_VOUT_VSPX_E_POS + 0x300,
	VPU_VOUT_VSLN_O_POS + 0x300,
	VPU_VOUT_VSPX_O_POS + 0x300,
	VPU_VOUT_DE_PX_EN + 0x300,
	VPU_VOUT_DELN_E_POS + 0x300,
	VPU_VOUT_DELN_O_POS + 0x300,
	VPU_VOUT_MAX_SIZE + 0x300,
	VPU_VOUT_FLD_BGN_LINE + 0x300,
	VPU_VOUTO_HS_POS + 0x300,
	VPU_VOUTO_VSLN_E_POS + 0x300,
	VPU_VOUTO_VSPX_E_POS + 0x300,
	VPU_VOUTO_VSLN_O_POS + 0x300,
	VPU_VOUTO_VSPX_O_POS + 0x300,
	VPU_VOUTO_DE_PX_EN + 0x300,
	VPU_VOUTO_DELN_E_POS + 0x300,
	VPU_VOUTO_DELN_O_POS + 0x300,
	VPU_VOUTO_MAX_SIZE + 0x300,
	VPU_VOUTO_FLD_BGN_LINE + 0x300,
	VPU_VOUT_BT_CTRL + 0x300,
	VPU_VOUT_BT_PLD_LINE + 0x300,
	VPU_VOUT_BT_PLDIDT0 + 0x300,
	VPU_VOUT_BT_PLDIDT1 + 0x300,
	VPU_VOUT_BT_BLK_DATA + 0x300,
	VPU_VOUT_BT_DAT_CLPY + 0x300,
	VPU_VOUT_BT_DAT_CLPC + 0x300,
	VPU_VOUT_BIST_CFG_YUV + 0x300,
	VPU_VOUT_CLRBAR_CFG + 0x300,
	VPU_VOUT_BIST_SEL + 0x300,
	VPU_VOUT_BIST_HIGH + 0x300,
	LCD_DEBUG_REG_END
};
