...
void dsi_phy_write(struct aml_lcd_drv_s *pdrv, u8 port, unsigned int reg, unsigned int value);
void dsi_phy_setb(struct aml_lcd_drv_s *pdrv, u8 port, unsigned int reg, unsigned int value,
		  u8 start, u8 len);
