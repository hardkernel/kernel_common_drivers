...
/* ============================================================================================= */
static inline void lcd_tcon_set_pre_cursor(struct aml_lcd_drv_s *pdrv, u16 x, u16 y)
{
	lcd_tcon_setb(pdrv, 0x205, (u32)x, 0, 14);
	lcd_tcon_setb(pdrv, 0x205, (u32)y, 14, 14);
}

static inline void lcd_tcon_get_pre_cursor(struct aml_lcd_drv_s *pdrv, u16 *r, u16 *g, u16 *b)
{
...
static inline void lcd_tcon_set_post_cursor(struct aml_lcd_drv_s *pdrv, u16 x, u16 y)
{
	lcd_tcon_setb(pdrv, 0x12d, (u32)x, 14, 12);
	lcd_tcon_setb(pdrv, 0x12d, (u32)y, 0, 14);
}

static inline void lcd_tcon_get_post_cursor(struct aml_lcd_drv_s *pdrv, u16 *r, u16 *g, u16 *b)
{
...
/*
 * create block buffer and add to pat block_list
...
s32 lcd_swpdf_vs_handle(void)
{
	...
	lcd_tcon_get_pre_cursor(pdrv, &pix->r, &pix->g, &pix->b);
	...
	lcd_tcon_set_pre_cursor(pdrv, pix->x, pix->y);
