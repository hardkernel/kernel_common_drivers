...
static void hdmitx21_edid_parse_sbtm_db(struct rx_cap *prxcap,
 ...
 */
				...
				case EXTENSION_IFDB_TAG:
					...
					break;
				default:
					HDMITX_INFO("warn: Unknown extended tag: %d, offset: %d\n",
						ext_tag, offset);
					break;
				}
			}
		...
		default:
			HDMITX_INFO("warn: Unknown EDID block type. tag: %d, offset: %d\n",
				tag, offset);
			offset++;
			offset += count;
			break;
