...
static struct di_class_debug_s di_debugfs_class_files[] = {
	...
	{"dim_trig_delay", &dim_trig_delay, 1, 0},
	{"insert_line", &insert_line, 1, 0},
	#ifdef NV21_DBG
	{"cfg_vf", &cfg_vf, 1, 0},
	#endif
	//{"di_stop_reg_addr", &di_stop_reg_addr, 1, 0},
	{"overturn", &overturn, 1, 0},
	#ifdef SUPPORT_MPEG_TO_VDIN
	{"mpeg2vdin_flag", &mpeg2vdin_flag, 1, 0},
	{"mpeg2vdin_en", &mpeg2vdin_en, 1, 0},
	#endif
	{"di_pre_rdma_enable", &di_pre_rdma_enable, 1, 0},
	{"pldn_dly", &pldn_dly, 1, 0},
	{"pldn_dly1", &pldn_dly1, 1, 0},
	{"di_reg_unreg_cnt", &di_reg_unreg_cnt, 1, 0},
	{"bypass_pre", &by_pass_pre, 1, 0},
	{"pd_source_en", &pd_source_en, 1, 0},
	#ifdef DBG_AFBC
	{"afbc_cfg_vf", &afbc_cfg_vf, 1, 0},
	{"afbc_cfg_bt", &afbc_cfg_bt, 1, 0},
	#endif
	{"sc2_dbg_cnt_pre", &sc2_dbg_cnt_pre, 1, 0},
	{"sc2_dbg_cnt_pst", &sc2_dbg_cnt_pst, 1, 0},
	{"sc2_dbg", &sc2_dbg, 1, 0},
	{"sc2_reg_mask", &sc2_reg_mask, 1, 0},
	{"dim_hf_dbg", &dim_hf_dbg, 1, 0},
	{"dim_nr_h", &dim_nr_h, 1, 0},
	{"dim_nr_v", &dim_nr_v, 1, 0},
	{"dim_bitmode", &dim_bitmode, 1, 0},
	{"dim_dbg_mode", &dim_dbg_mode, 1, 0},
	{"new_int", &new_int, 1, 0},
	{"dbg_sct_cfg", &dbg_sct_cfg, 1, 0},
	#ifdef MARK_HIS
	...
	#endif
	{"di_forc_pq_load_later", &di_forc_pq_load_later, 1, 0},
	{"dim_dbg_dec21", &dim_dbg_dec21, 1, 0},
	#ifdef DBG_POST_SETTING
	{"dim_dbg_post", &dim_dbg_post, 1, 0},
	#endif
	{"dbg_trig_eos", &dbg_trig_eos, 1, 0},
	#ifdef AFBC_DBG
	{"sleep_cnt", &sleep_cnt, 1, 0},
	#endif
	{"dpvpp_dbg_force_dech", &dpvpp_dbg_force_dech, 1, 0},
	{"dpvpp_dbg_force_decv", &dpvpp_dbg_force_decv, 1, 0},
	{"dnr_pr", &dnr_pr, 1, 0},
	...
	{"cue_en", &cue_en, 1, 0},
	{"cue_en_force_disable", &cue_en_force_disable, 1, 0},
	{"glb_fieldck_en", &glb_fieldck_en, 1, 0},
	{"invert_cue_phase", &invert_cue_phase, 1, 0},
	{"cue_pr_cnt", &cue_pr_cnt, 1, 0},
	{"cue_glb_mot_check_en", &cue_glb_mot_check_en, 1, 0},
	{"cue_en_last", &cue_en_last, 1, 0},
	{"flm22_sure_num", &flm22_sure_num, 1, 0},
	{"flm22_ratio", &flm22_ratio, 1, 0},
	{"pldn_cmb0", &pldn_cmb0, 1, 0},
	{"pldn_cmb1", &pldn_cmb1, 1, 0},
	{"flag_di_weave", &flag_di_weave, 1, 0},
	{"flmxx_sure_num", &flmxx_sure_num, 1, 0},
	{"flm22_glbpxlnum_rat", &flm22_glbpxlnum_rat, 1, 0},
	{"flm22_glbpxl_maxrow", &flm22_glbpxl_maxrow, 1, 0},
	{"flm22_glbpxl_minrow", &flm22_glbpxl_minrow, 1, 0},
	{"cmb_3point_rnum", &cmb_3point_rnum, 1, 0},
	{"cmb_3point_rrat", &cmb_3point_rrat, 1, 0},
	{"dim_dbg_o_vtype", &dim_dbg_o_vtype, 1, 0},
	{"flmxx_maybe_num", &flmxx_maybe_num, 1, 0},
	{"flm32_mim_frms", &flm32_mim_frms, 1, 0},
	{"flm22_dif01a_flag", &flm22_dif01a_flag, 1, 0},
	{"flm22_mim_frms", &flm22_mim_frms, 1, 0},
	{"flm22_mim_smfrms", &flm22_mim_smfrms, 1, 0},
	{"flm32_f2fdif_min0", &flm32_f2fdif_min0, 1, 0},
	{"flm32_f2fdif_min1", &flm32_f2fdif_min1, 1, 0},
	{"flm32_chk1_rtn", &flm32_chk1_rtn, 1, 0},
	{"flm32_ck13_rtn", &flm32_ck13_rtn, 1, 0},
	{"flm32_chk2_rtn", &flm32_chk2_rtn, 1, 0},
	{"flm32_chk3_rtn", &flm32_chk3_rtn, 1, 0},
	{"flm32_dif02_ratio", &flm32_dif02_ratio, 1, 0},
	{"flm22_chk20_sml", &flm22_chk20_sml, 1, 0},
	{"flm22_chk21_sml", &flm22_chk21_sml, 1, 0},
	{"flm22_chk21_sm2", &flm22_chk21_sm2, 1, 0},
	{"flm22_lavg_sft", &flm22_lavg_sft, 1, 0},
	{"flm22_lavg_lg", &flm22_lavg_lg, 1, 0},
	{"flm22_stl_sft", &flm22_stl_sft, 1, 0},
	{"flm22_chk5_avg", &flm22_chk5_avg, 1, 0},
	{"flm22_chk6_max", &flm22_chk6_max, 1, 0},
	{"flm22_anti_chk1", &flm22_anti_chk1, 1, 0},
	{"flm22_anti_chk3", &flm22_anti_chk3, 1, 0},
	{"flm22_anti_chk4", &flm22_anti_chk4, 1, 0},
	{"flm22_anti_ck140", &flm22_anti_ck140, 1, 0},
	{"flm22_anti_ck141", &flm22_anti_ck141, 1, 0},
	{"flm22_frmdif_max", &flm22_frmdif_max, 1, 0},
	{"flm22_flddif_max", &flm22_flddif_max, 1, 0},
	{"flm22_minus_cntmax", &flm22_minus_cntmax, 1, 0},
	{"flagdif01chk", &flagdif01chk, 1, 0},
	{"dif01_ratio", &dif01_ratio, 1, 0},
	{"nflagch4_ratio", &nflagch4_ratio, 1, 0},
	{"nflagch5_ratio", &nflagch5_ratio, 1, 0},
	{"nflagch4_th", &nflagch4_th, 1, 0},
	{"nflagch5_th", &nflagch5_th, 1, 0},
	{"dif02_flag", &dif02_flag, 1, 0},
	{"dif02_ratio", &dif02_ratio, 1, 0},
	{"pr_pd", &pr_pd, 1, 0},
	{"flm2224_stl_sft", &flm2224_stl_sft, 1, 0},
	{"cmb32_blw_wnd", &cmb32_blw_wnd, 1, 0},
	{"cmb32_wnd_ext", &cmb32_wnd_ext, 1, 0},
	{"cmb32_wnd_tol", &cmb32_wnd_tol, 1, 0},
	{"cmb32_frm_nocmb", &cmb32_frm_nocmb, 1, 0},
	{"cmb32_min02_sft", &cmb32_min02_sft, 1, 0},
	{"cmb32_cmb_tol", &cmb32_cmb_tol, 1, 0},
	{"cmb32_avg_dff", &cmb32_avg_dff, 1, 0},
	{"cmb32_smfrm_num", &cmb32_smfrm_num, 1, 0},
	{"cmb32_nocmb_num", &cmb32_nocmb_num, 1, 0},
	{"cmb22_gcmb_rnum", &cmb22_gcmb_rnum, 1, 0},
	{"flmxx_cal_lcmb", &flmxx_cal_lcmb, 1, 0},
