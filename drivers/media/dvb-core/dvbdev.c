...
#ifdef CONFIG_AMLOGIC_DVB_DYNAMIC_MINORS
...
{
#if defined(CONFIG_AMLOGIC_MEDIA_CONTROLLER_DVB)
	if (dvbdev->entity) {
...
#ifdef CONFIG_AMLOGIC_MEDIA_CONTROLLER_DVB
...
#if IS_ENABLED(CONFIG_AMLOGIC_I2C)
