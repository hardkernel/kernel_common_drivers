...
static ssize_t show_help(const struct class *class, const struct class_attribute *attr,
			 char *buf)
{
	ssize_t size = 0;
...
static ssize_t cam_info_show(const struct class *class, const struct class_attribute *attr,
	char *buf)
{
	struct list_head *p;
