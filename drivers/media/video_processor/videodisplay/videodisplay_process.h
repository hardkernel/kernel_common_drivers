...
enum videodisplay_debug_class_type {
	...
	VD_DEBUG_CLASS_USE_LOW_LATENCY,
	VD_DEBUG_CLASS_LAST_FRAME_INDEX,
	VD_DEBUG_CLASS_VD_COMPOSER_EN,
	VD_DEBUG_CLASS_DROP_ORG_I,
	VD_DEBUG_CLASS_DROP_HDMI_COUNT,
	VD_DEBUG_CLASS_MAX
};
