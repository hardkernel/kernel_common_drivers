				...
				bool toggle)
{
	...
	if (debug_dolby & 1)
		pr_dv_dbg("top1_set:on %d %d,reset %d,toggle %d,video %d,py_id %d,%d\n",
				   top1_info.core_on, top1_info.core_on_cnt,
				   reset, toggle, video_enable, top1_info.py_id, vpp_vsync_id);
