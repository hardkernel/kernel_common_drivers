			      ...
			      u32 *key, u32 keylen, u32 *iv)
{
	...
	status = aml_dma_do_hw_crypto(dd->dma, dd->descriptor, nents, dd->dma_descript_tab,
				      USE_BUSY_POLLING, DMA_FLAG_TDES_IN_USE);
