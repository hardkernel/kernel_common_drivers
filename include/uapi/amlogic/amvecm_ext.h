...
#define AMVECM_IOC_LOAD_3D_LUT			_IOW(_VE_CM, 0x6e, int)
#define AMVECM_IOC_SET_3D_LUT_ORDER		_IOW(_VE_CM, 0x6f, int)
...
#define AMVECM_IOC_3D_LUT_EN			_IOW(_VE_CM, 0x7c, int)
...
#define AMVECM_IOC_COLOR_MTX_EN			_IOW(_VE_CM, 0x80, int)
...
#define AMVECM_IOC_AI_COLOR_EN      _IOW(_VE_CM, 0x8b, int)
#define AMVECM_IOC_S_AI_COLOR_PARAM _IOW(_VE_CM, 0x8c, struct db_aicolor_param_s)
#define AMVECM_IOC_S_SDR2HDR_CTRL   _IOW(_VE_CM, 0x8d, int)
...
#define AMVECM_IOC_S_HDR_TOP_CTRL_MODE _IOW(_VE_CM, 0x90, int)
...
#define AMVECM_IOC_S_PQ_LOAD_EN      _IOW(_VE_CM, 0x96, unsigned int)
...
#define AMVECM_IOC_S_CM_CTRL     _IOW(_VE_CM, 0xa0, int)
#define AMVECM_IOC_S_FORCE_OUT   _IOW(_VE_CM, 0xa1, int)
#define AMVECM_IOC_S_HDR_POLICY  _IOW(_VE_CM, 0xa2, int)
#define AMVECM_IOC_S_HDR_MODE    _IOW(_VE_CM, 0xa3, int)
#define AMVECM_IOC_S_SDR_MODE    _IOW(_VE_CM, 0xa4, int)
#define AMVECM_IOC_S_CUVA_SDR_MAX_LUM    _IOW(_VE_CM, 0xa5, int)
#define AMVECM_IOC_S_CUVA_HDR_MAX_LUM    _IOW(_VE_CM, 0xa6, int)
...
#define AMVECM_IOC_G_SIGNAL_TYPE      _IOR(_VE_CM, 0xb4, unsigned int)
