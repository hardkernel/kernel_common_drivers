...
enum tvin_sig_fmt_e {
	...
	TVIN_SIG_FMT_HDMI_3072X2160_60HZ = 0x472,
	TVIN_SIG_FMT_HDMI_2560X2160_60HZ = 0x473,
	TVIN_SIG_FMT_HDMI_2048_1080 = 0x474,
	TVIN_SIG_FMT_HDMI_MAX,

	TVIN_SIG_FMT_HDR10_480 = 0x500,
	TVIN_SIG_FMT_HDR10_576 = 0x501,
	TVIN_SIG_FMT_HDR10_720 = 0x502,
	TVIN_SIG_FMT_HDR10_1080 = 0x503,
	TVIN_SIG_FMT_HDR10_4K2K = 0x504,

	TVIN_SIG_FMT_HDRPLUS_480 = 0x505,
	TVIN_SIG_FMT_HDRPLUS_576 = 0x506,
	TVIN_SIG_FMT_HDRPLUS_720 = 0x507,
	TVIN_SIG_FMT_HDRPLUS_1080 = 0x508,
	TVIN_SIG_FMT_HDRPLUS_4K2K = 0x509,

	TVIN_SIG_FMT_HLG_480 = 0x50a,
	TVIN_SIG_FMT_HLG_576 = 0x50b,
	TVIN_SIG_FMT_HLG_720 = 0x50c,
	TVIN_SIG_FMT_HLG_1080 = 0x50d,
	TVIN_SIG_FMT_HLG_4K2K = 0x50e,

	TVIN_SIG_FMT_AMLDOLBY_480 = 0x50f,
	TVIN_SIG_FMT_AMLDOLBY_576 = 0x510,
	TVIN_SIG_FMT_AMLDOLBY_720 = 0x511,
	TVIN_SIG_FMT_AMLDOLBY_1080 = 0x512,
	TVIN_SIG_FMT_AMLDOLBY_4K2K = 0x513,

	TVIN_SIG_FMT_HDR_8K = 0x514,
	TVIN_SIG_FMT_HDRPLUS_8K = 0x515,
	TVIN_SIG_FMT_HLG_8K = 0x516,
	TVIN_SIG_FMT_AMLDOLBY_8K = 0x517,
...
enum port_mode {
	CAPTURE_VPP0_OSD_VIDEO  = 0,/* vpp0 osd+video */
	CAPTURE_VPP0_VIDEO_ONLY = 1,/* vpp0 video only */
	CAPTURE_VPP1_OSD_VIDEO  = 2,/* vpp1 osd+video */
	CAPTURE_VPP1_VIDEO_ONLY = 3,/* vpp1 video only */
	CAPTURE_VPP2_OSD_VIDEO  = 4,/* vpp2 osd+video */
	CAPTURE_VPP2_VIDEO_ONLY = 5,/* vpp2 video only */
	CAPTURE_VPP0_VIDEO_ONLY_NO_PQ = 6,/* vpp0 video only no pq*/
	CAPTURE_VPP0_OSD_VIDEO_NO_PQ = 7,/* vpp0 osd+video no pq*/

	CAPTURE_VPP0_OSD1_ONLY,/* vpp0 osd1 only */
	CAPTURE_VPP0_OSD2_ONLY,/* vpp0 osd2 only */
	CAPTURE_VPP0_OSD3_ONLY,/* vpp0 osd3 only */

	CAPTURE_VPP1_OSD1_ONLY,/* vpp1 osd1 only */
	CAPTURE_VPP1_OSD2_ONLY,/* vpp1 osd2 only */
	CAPTURE_VPP1_OSD3_ONLY,/* vpp1 osd3 only */

	CAPTURE_VPP2_OSD1_ONLY,/* vpp2 osd1 only */
	CAPTURE_VPP2_OSD2_ONLY,/* vpp2 osd2 only */
	CAPTURE_VPP2_OSD3_ONLY,/* vpp2 osd3 only */
