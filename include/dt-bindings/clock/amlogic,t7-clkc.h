...
#ifndef _DT_BINDINGS_CLOCK_AMLOGIC_T7_CLKC_H
#define _DT_BINDINGS_CLOCK_AMLOGIC_T7_CLKC_H

#define CLKID_GP0_PLL			0
#define CLKID_GP1_PLL			1
#define CLKID_MCLK_PLL			2
#define CLKID_MCLK_PLL_DIV		3
#define CLKID_HIFI_PLL			4
#define CLKID_PCIE_PLL_DCO		5
#define CLKID_PCIE_PLL_DCO_DIV2		6
#define CLKID_PCIE_PLL_OD		7
#define CLKID_PCIE_PLL			8
#define CLKID_HDMI_PLL_DCO		9
#define CLKID_HDMI_PLL_OD		10
#define CLKID_HDMI_PLL			11
#define CLKID_MPLL_50M_DIV		12
#define CLKID_MPLL_50M			13
#define CLKID_MPLL_PREDIV		14
#define CLKID_MPLL0_DIV			15
#define CLKID_MPLL0			16
#define CLKID_MPLL1_DIV			17
#define CLKID_MPLL1			18
#define CLKID_MPLL2_DIV			19
#define CLKID_MPLL2			20
#define CLKID_MPLL3_DIV			21
#define CLKID_MPLL3			22
#define CLKID_PCIE_BGP			23
#define CLKID_PCIE_HCSL			24

#define CLKID_BASE			25
...
#define CLKID_CECA_32K_CLKIN		(CLKID_BASE + 5)
#define CLKID_CECA_32K_DIV		(CLKID_BASE + 6)
#define CLKID_CECA_32K_MUX_PRE		(CLKID_BASE + 7)
#define CLKID_CECA_32K_MUX		(CLKID_BASE + 8)
#define CLKID_CECA_32K_CLKOUT		(CLKID_BASE + 9)
#define CLKID_CECB_32K_CLKIN		(CLKID_BASE + 10)
#define CLKID_CECB_32K_DIV		(CLKID_BASE + 11)
#define CLKID_CECB_32K_MUX_PRE		(CLKID_BASE + 12)
#define CLKID_CECB_32K_MUX		(CLKID_BASE + 13)
#define CLKID_CECB_32K_CLKOUT		(CLKID_BASE + 14)
#define CLKID_SC_CLK_MUX		(CLKID_BASE + 15)
#define CLKID_SC_CLK_DIV		(CLKID_BASE + 16)
#define CLKID_SC_CLK_GATE		(CLKID_BASE + 17)
#define CLKID_DSPA_CLK_B_MUX		(CLKID_BASE + 18)
#define CLKID_DSPA_CLK_B_DIV		(CLKID_BASE + 19)
#define CLKID_DSPA_CLK_B_GATE		(CLKID_BASE + 20)
#define CLKID_DSPA_CLK_A_MUX		(CLKID_BASE + 21)
#define CLKID_DSPA_CLK_A_DIV		(CLKID_BASE + 22)
#define CLKID_DSPA_CLK_A_GATE		(CLKID_BASE + 23)
#define CLKID_DSPA_CLK			(CLKID_BASE + 24)
#define CLKID_24M_CLK_GATE		(CLKID_BASE + 25)
#define CLKID_12M_CLK_DIV		(CLKID_BASE + 26)
#define CLKID_12M_CLK_GATE		(CLKID_BASE + 27)
#define CLKID_25M_CLK_DIV		(CLKID_BASE + 28)
#define CLKID_25M_CLK_GATE		(CLKID_BASE + 29)
#define CLKID_VID_PLL_DIV		(CLKID_BASE + 30)
#define CLKID_VID_PLL_MUX		(CLKID_BASE + 31)
#define CLKID_VID_PLL			(CLKID_BASE + 32)
#define CLKID_VCLK_MUX			(CLKID_BASE + 33)
#define CLKID_VCLK2_MUX			(CLKID_BASE + 34)
#define CLKID_VCLK_INPUT		(CLKID_BASE + 35)
#define CLKID_VCLK2_INPUT		(CLKID_BASE + 36)
#define CLKID_VCLK_DIV			(CLKID_BASE + 37)
#define CLKID_VCLK2_DIV			(CLKID_BASE + 38)
#define CLKID_VCLK			(CLKID_BASE + 39)
#define CLKID_VCLK2			(CLKID_BASE + 40)
#define CLKID_VCLK_DIV1			(CLKID_BASE + 41)
#define CLKID_VCLK_DIV2_EN		(CLKID_BASE + 42)
#define CLKID_VCLK_DIV4_EN		(CLKID_BASE + 43)
#define CLKID_VCLK_DIV6_EN		(CLKID_BASE + 44)
#define CLKID_VCLK_DIV12_EN		(CLKID_BASE + 45)
#define CLKID_VCLK2_DIV1		(CLKID_BASE + 46)
#define CLKID_VCLK2_DIV2_EN		(CLKID_BASE + 47)
#define CLKID_VCLK2_DIV4_EN		(CLKID_BASE + 48)
#define CLKID_VCLK2_DIV6_EN		(CLKID_BASE + 49)
#define CLKID_VCLK2_DIV12_EN		(CLKID_BASE + 50)
#define CLKID_VCLK_DIV2			(CLKID_BASE + 51)
#define CLKID_VCLK_DIV4			(CLKID_BASE + 52)
#define CLKID_VCLK_DIV6			(CLKID_BASE + 53)
#define CLKID_VCLK_DIV12		(CLKID_BASE + 54)
#define CLKID_VCLK2_DIV2		(CLKID_BASE + 55)
#define CLKID_VCLK2_DIV4		(CLKID_BASE + 56)
#define CLKID_VCLK2_DIV6		(CLKID_BASE + 57)
#define CLKID_VCLK2_DIV12		(CLKID_BASE + 58)
#define CLKID_CTS_ENCI_MUX		(CLKID_BASE + 59)
#define CLKID_CTS_ENCP_MUX		(CLKID_BASE + 60)
#define CLKID_CTS_VDAC_MUX		(CLKID_BASE + 61)
#define CLKID_HDMI_TX_MUX		(CLKID_BASE + 62)
#define CLKID_CTS_ENCI			(CLKID_BASE + 63)
#define CLKID_CTS_ENCP			(CLKID_BASE + 64)
#define CLKID_CTS_VDAC			(CLKID_BASE + 65)
#define CLKID_HDMI_TX			(CLKID_BASE + 66)
#define CLKID_HDMITX_SYS_MUX		(CLKID_BASE + 67)
#define CLKID_HDMITX_SYS_DIV		(CLKID_BASE + 68)
#define CLKID_HDMITX_SYS		(CLKID_BASE + 69)
#define CLKID_TS_CLK_DIV		(CLKID_BASE + 70)
#define CLKID_TS_CLK_GATE		(CLKID_BASE + 71)
#define CLKID_MALI_0_SEL		(CLKID_BASE + 72)
#define CLKID_MALI_0_DIV		(CLKID_BASE + 73)
#define CLKID_MALI_0			(CLKID_BASE + 74)
#define CLKID_MALI_1_SEL		(CLKID_BASE + 75)
#define CLKID_MALI_1_DIV		(CLKID_BASE + 76)
#define CLKID_MALI_1			(CLKID_BASE + 77)
#define CLKID_MALI_MUX			(CLKID_BASE + 78)
#define CLKID_VDEC_P0_MUX		(CLKID_BASE + 79)
#define CLKID_VDEC_P0_DIV		(CLKID_BASE + 80)
#define CLKID_VDEC_P0			(CLKID_BASE + 81)
#define CLKID_VDEC_P1_MUX		(CLKID_BASE + 82)
#define CLKID_VDEC_P1_DIV		(CLKID_BASE + 83)
#define CLKID_VDEC_P1			(CLKID_BASE + 84)
#define CLKID_VDEC_MUX			(CLKID_BASE + 85)
#define CLKID_HCODEC_P0_MUX		(CLKID_BASE + 86)
#define CLKID_HCODEC_P0_DIV		(CLKID_BASE + 87)
#define CLKID_HCODEC_P0			(CLKID_BASE + 88)
#define CLKID_HCODEC_P1_MUX		(CLKID_BASE + 89)
#define CLKID_HCODEC_P1_DIV		(CLKID_BASE + 90)
#define CLKID_HCODEC_P1			(CLKID_BASE + 91)
#define CLKID_HCODEC_MUX		(CLKID_BASE + 92)
#define CLKID_HEVCB_P0_MUX		(CLKID_BASE + 93)
#define CLKID_HEVCB_P0_DIV		(CLKID_BASE + 94)
#define CLKID_HEVCB_P0			(CLKID_BASE + 95)
#define CLKID_HEVCB_P1_MUX		(CLKID_BASE + 96)
#define CLKID_HEVCB_P1_DIV		(CLKID_BASE + 97)
#define CLKID_HEVCB_P1			(CLKID_BASE + 98)
#define CLKID_HEVCB_MUX			(CLKID_BASE + 99)
#define CLKID_HEVCF_P0_MUX		(CLKID_BASE + 100)
#define CLKID_HEVCF_P0_DIV		(CLKID_BASE + 101)
#define CLKID_HEVCF_P0			(CLKID_BASE + 102)
#define CLKID_HEVCF_P1_MUX		(CLKID_BASE + 103)
#define CLKID_HEVCF_P1_DIV		(CLKID_BASE + 104)
#define CLKID_HEVCF_P1			(CLKID_BASE + 105)
#define CLKID_HEVCF_MUX			(CLKID_BASE + 106)
#define CLKID_WAVE_A_MUX		(CLKID_BASE + 107)
#define CLKID_WAVE_A_DIV		(CLKID_BASE + 108)
#define CLKID_WAVE_A_GATE		(CLKID_BASE + 109)
#define CLKID_WAVE_B_MUX		(CLKID_BASE + 110)
#define CLKID_WAVE_B_DIV		(CLKID_BASE + 111)
#define CLKID_WAVE_B_GATE		(CLKID_BASE + 112)
#define CLKID_WAVE_C_MUX		(CLKID_BASE + 113)
#define CLKID_WAVE_C_DIV		(CLKID_BASE + 114)
#define CLKID_WAVE_C_GATE		(CLKID_BASE + 115)
#define CLKID_VPU_0_MUX			(CLKID_BASE + 116)
#define CLKID_VPU_0_DIV			(CLKID_BASE + 117)
#define CLKID_VPU_0			(CLKID_BASE + 118)
#define CLKID_VPU_1_MUX			(CLKID_BASE + 119)
#define CLKID_VPU_1_DIV			(CLKID_BASE + 120)
#define CLKID_VPU_1			(CLKID_BASE + 121)
#define CLKID_VPU			(CLKID_BASE + 122)
#define CLKID_VPU_CLKB_TMP_MUX		(CLKID_BASE + 123)
#define CLKID_VPU_CLKB_TMP_DIV		(CLKID_BASE + 124)
#define CLKID_VPU_CLKB_TMP		(CLKID_BASE + 125)
#define CLKID_VPU_CLKB_DIV		(CLKID_BASE + 126)
#define CLKID_VPU_CLKB			(CLKID_BASE + 127)
#define CLKID_VPU_CLKC_P0_MUX		(CLKID_BASE + 128)
#define CLKID_VPU_CLKC_P0_DIV		(CLKID_BASE + 129)
#define CLKID_VPU_CLKC_P0		(CLKID_BASE + 130)
#define CLKID_VPU_CLKC_P1_MUX		(CLKID_BASE + 131)
#define CLKID_VPU_CLKC_P1_DIV		(CLKID_BASE + 132)
#define CLKID_VPU_CLKC_P1		(CLKID_BASE + 133)
#define CLKID_VPU_CLKC_MUX		(CLKID_BASE + 134)
#define CLKID_VAPB_0_MUX		(CLKID_BASE + 135)
#define CLKID_VAPB_0_DIV		(CLKID_BASE + 136)
#define CLKID_VAPB_0			(CLKID_BASE + 137)
#define CLKID_VAPB_1_MUX		(CLKID_BASE + 138)
#define CLKID_VAPB_1_DIV		(CLKID_BASE + 139)
#define CLKID_VAPB_1			(CLKID_BASE + 140)
#define CLKID_VAPB			(CLKID_BASE + 141)
#define CLKID_GE2D			(CLKID_BASE + 142)
#define CLKID_VDIN_MEAS_MUX		(CLKID_BASE + 143)
#define CLKID_VDIN_MEAS_DIV		(CLKID_BASE + 144)
#define CLKID_VDIN_MEAS_GATE		(CLKID_BASE + 145)
#define CLKID_DSI_A_MEAS_MUX		(CLKID_BASE + 146)
#define CLKID_DSI_A_MEAS_DIV		(CLKID_BASE + 147)
#define CLKID_DSI_A_MEAS_GATE		(CLKID_BASE + 148)
#define CLKID_DSI_B_MEAS_MUX		(CLKID_BASE + 149)
#define CLKID_DSI_B_MEAS_DIV		(CLKID_BASE + 150)
#define CLKID_DSI_B_MEAS_GATE		(CLKID_BASE + 151)
#define CLKID_DSI0_PHY_MUX		(CLKID_BASE + 152)
#define CLKID_DSI0_PHY_DIV		(CLKID_BASE + 153)
#define CLKID_DSI0_PHY_GATE		(CLKID_BASE + 154)
#define CLKID_DSI1_PHY_MUX		(CLKID_BASE + 155)
#define CLKID_DSI1_PHY_DIV		(CLKID_BASE + 156)
#define CLKID_DSI1_PHY_GATE		(CLKID_BASE + 157)
#define CLKID_VID_LOCK_DIV		(CLKID_BASE + 158)
#define CLKID_VID_LOCK			(CLKID_BASE + 159)
#define PERI_BASE			(CLKID_BASE + 160)
...
#endif /* _DT_BINDINGS_CLOCK_AMLOGIC_T7_CLKC_H */
