...
#define CLKID_SYS_PLL			(CLKID_PLL_BASE + 16)
#define CLKID_GP0_PLL			(CLKID_PLL_BASE + 17)
#define CLKID_HIFI_PLL			(CLKID_PLL_BASE + 18)
...
#define CLKID_RTC_32K_CLKIN		(CLKID_CLK_BASE + 0)
#define CLKID_RTC_32K_DIV		(CLKID_CLK_BASE + 1)
#define CLKID_RTC_32K_MUX		(CLKID_CLK_BASE + 2)
#define CLKID_RTC_32K			(CLKID_CLK_BASE + 3)
...
#define CLKID_CECB_32K_MUX		(CLKID_CLK_BASE + 95)
#define CLKID_CECB_CLK_SEL		(CLKID_CLK_BASE + 96)
...
#define CLKID_SAR_ADC_MUX		(CLKID_CLK_BASE + 210)
#define CLKID_SAR_ADC_DIV		(CLKID_CLK_BASE + 211)
#define CLKID_SAR_ADC			(CLKID_CLK_BASE + 212)

#define NR_CLKS				(CLKID_CLK_BASE + 213)
