...
#define CLKID_MPLL_50M			(CLKID_PLL_BASE + 14)
#define CLKID_GP0_PLL_DCO		(CLKID_PLL_BASE + 15)
#define CLKID_GP0_PLL			(CLKID_PLL_BASE + 16)
#define CLKID_HIFI_PLL_DCO		(CLKID_PLL_BASE + 27)
#define CLKID_HIFI_PLL			(CLKID_PLL_BASE + 28)

#define CLKID_BASE			(CLKID_PLL_BASE + 29)
