...
#define CLKID_SYS_PLL			(CLKID_PLL_BASE + 2)
#define CLKID_FCLK_DIV2_DIV		(CLKID_PLL_BASE + 3)
#define CLKID_FCLK_DIV2			(CLKID_PLL_BASE + 4)
#define CLKID_FCLK_DIV3_DIV		(CLKID_PLL_BASE + 5)
#define CLKID_FCLK_DIV3			(CLKID_PLL_BASE + 6)
#define CLKID_FCLK_DIV4_DIV		(CLKID_PLL_BASE + 7)
#define CLKID_FCLK_DIV4			(CLKID_PLL_BASE + 8)
#define CLKID_FCLK_DIV5_DIV		(CLKID_PLL_BASE + 9)
#define CLKID_FCLK_DIV5			(CLKID_PLL_BASE + 10)
#define CLKID_FCLK_DIV7_DIV		(CLKID_PLL_BASE + 11)
#define CLKID_FCLK_DIV7			(CLKID_PLL_BASE + 12)
#define CLKID_FCLK_DIV2P5_DIV		(CLKID_PLL_BASE + 13)
#define CLKID_FCLK_DIV2P5		(CLKID_PLL_BASE + 14)
#define CLKID_GP0_PLL			(CLKID_PLL_BASE + 15)
#define CLKID_GP1_PLL			(CLKID_PLL_BASE + 16)

#define CLKID_CPU_BASE			(CLKID_PLL_BASE  + 17)
...
#define CLKID_HIFI_PLL			(CLKID_PLL1_BASE + 0)
#define CLKID_PCIE_PLL_DCO		(CLKID_PLL1_BASE + 1)
#define CLKID_PCIE_PLL_DCO_DIV2		(CLKID_PLL1_BASE + 2)
#define CLKID_PCIE_PLL_OD		(CLKID_PLL1_BASE + 3)
#define CLKID_PCIE_PLL			(CLKID_PLL1_BASE + 4)
#define CLKID_HDMI_PLL_DCO		(CLKID_PLL1_BASE + 5)
#define CLKID_HDMI_PLL_OD		(CLKID_PLL1_BASE + 6)
#define CLKID_HDMI_PLL			(CLKID_PLL1_BASE + 7)
#define CLKID_MPLL_50M_DIV		(CLKID_PLL1_BASE + 8)
#define CLKID_MPLL_50M			(CLKID_PLL1_BASE + 9)
#define CLKID_MPLL_PREDIV		(CLKID_PLL1_BASE + 10)
#define CLKID_MPLL0_DIV			(CLKID_PLL1_BASE + 11)
#define CLKID_MPLL0			(CLKID_PLL1_BASE + 12)
#define CLKID_MPLL1_DIV			(CLKID_PLL1_BASE + 13)
#define CLKID_MPLL1			(CLKID_PLL1_BASE + 14)
#define CLKID_MPLL2_DIV			(CLKID_PLL1_BASE + 15)
#define CLKID_MPLL2			(CLKID_PLL1_BASE + 16)
#define CLKID_MPLL3_DIV			(CLKID_PLL1_BASE + 17)
#define CLKID_MPLL3			(CLKID_PLL1_BASE + 18)

#define CLKID_BASE			(CLKID_PLL1_BASE + 19)
