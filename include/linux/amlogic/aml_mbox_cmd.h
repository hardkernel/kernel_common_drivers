...
#define CMD_TRIGGER_DSP2AP_SEND 0x6E
#define CMD_SEND_DSP2AP_TEST    0x6F
...
#define MBOX_CMD_TRIGGER_DSP2AP_SEND	__MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_TRIGGER_DSP2AP_SEND)
#define MBOX_CMD_SEND_DSP2AP_TEST	__MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_SEND_DSP2AP_TEST)
