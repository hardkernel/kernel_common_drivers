...
#define CMD_RTC_ENABLE_ALRM	0x3d
...
#define CMD_WATCHKEY_CTRL	0x52
#define CMD_HIFI5_SYSLOG_START  0x63
#define CMD_SET_FD650           0x68
#define CMD_GET_SPINLOCK        0x69
#define CMD_TRIGGER_AO2AP_SEND  0x6C
#define CMD_SEND_AO2AP_TEST     0x6D
#define CMD_TRIGGER_DSPA2AP_SEND 0x6E
#define CMD_SEND_DSPA2AP_TEST    0x6F
#define CMD_TRIGGER_DSPB2AP_SEND 0x71
#define CMD_SEND_DSPB2AP_TEST    0x72
#define CMD_REFRESH_BL30_LOG     0x73
#if IS_ENABLED(CONFIG_AMLOGIC_DEBUG_AOCPU_MONITOR)
#define CMD_SEND_ARM_ALIVE_MSG  0x75
#endif
...
#define MBOX_CMD_RTC_ENABLE_ALRM	__MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_RTC_ENABLE_ALRM)
...
#define MBOX_CMD_GET_SPINLOCK          __MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_GET_SPINLOCK)
...
#define MBOX_CMD_TRIGGER_AO2AP_SEND	__MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_TRIGGER_AO2AP_SEND)
#define MBOX_CMD_SEND_AO2AP_TEST	__MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_SEND_AO2AP_TEST)
#define MBOX_CMD_TRIGGER_DSPA2AP_SEND	__MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_TRIGGER_DSPA2AP_SEND)
#define MBOX_CMD_SEND_DSPA2AP_TEST	__MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_SEND_DSPA2AP_TEST)
#define MBOX_CMD_TRIGGER_DSPB2AP_SEND	__MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_TRIGGER_DSPB2AP_SEND)
#define MBOX_CMD_SEND_DSPB2AP_TEST	__MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_SEND_DSPB2AP_TEST)
#if IS_ENABLED(CONFIG_AMLOGIC_DEBUG_AOCPU_MONITOR)
#define MBOX_CMD_SEND_ARM_ALIVE_MSG	__MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_SEND_ARM_ALIVE_MSG)
#endif
...
#define MBOX_CMD_REFRESH_BL30_LOG	 __MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_REFRESH_BL30_LOG)
/*to aocpu cec module*/
...
#define MBOX_CMD_WATCHKEY_CTRL		__MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_WATCHKEY_CTRL)
