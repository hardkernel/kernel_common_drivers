...
#define AUX_PKT_GET_QMS_NEXT_TFR              (CMD_AUX_PKT_OFFSET + 0x40)
#define AUX_PKT_GET_QMS_BASE_REFRESH_RATE     (CMD_AUX_PKT_OFFSET + 0x41)
#define AUX_PKT_GET_SPD_SDI                   (CMD_AUX_PKT_OFFSET + 0x42)
