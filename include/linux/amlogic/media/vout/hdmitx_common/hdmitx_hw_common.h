...
#define AUX_PKT_SET_EMP					      (CMD_AUX_PKT_OFFSET + 0x21)
...
#define AUX_PKT_GET_QMS_M_CONST	              (CMD_AUX_PKT_OFFSET + 0x38)
#define AUX_PKT_GET_QMS_NEXT_TFR              (CMD_AUX_PKT_OFFSET + 0x39)
#define AUX_PKT_GET_QMS_BASE_REFRESH_RATE     (CMD_AUX_PKT_OFFSET + 0x40)
#define AUX_PKT_GET_TMDS_CLK                  (CMD_AUX_PKT_OFFSET + 0x41)
#define AUX_PKT_GET_PIXEL_CLK                 (CMD_AUX_PKT_OFFSET + 0x42)
#define AUX_PKT_GET_VSIF_IEEEOUI              (CMD_AUX_PKT_OFFSET + 0x43)
#define AUX_PKT_GET_VSIF_VIC                  (CMD_AUX_PKT_OFFSET + 0x44)
#define AUX_PKT_GET_VSIF_ALLM                 (CMD_AUX_PKT_OFFSET + 0x45)
#define AUX_PKT_GET_VSIF_AMDV_SIGNAL          (CMD_AUX_PKT_OFFSET + 0x46)
#define AUX_PKT_GET_VSIF_AMDV_LOW_LATENCY     (CMD_AUX_PKT_OFFSET + 0x47)
