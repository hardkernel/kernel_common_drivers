...
#define AUX_PKT_GET_AVI_BT2020			(CMD_AUX_PKT_OFFSET + 0x0a)
#define AUX_PKT_CONF_AVI_Q01			(CMD_AUX_PKT_OFFSET + 0x0b)
#define AUX_PKT_CONF_AVI_YQ01			(CMD_AUX_PKT_OFFSET + 0x0c)
#define AUX_PKT_CONF_AVI_CT				(CMD_AUX_PKT_OFFSET + 0x0d)
#define AUX_PKT_CONF_AVI_ASPECT			(CMD_AUX_PKT_OFFSET + 0x0e)
#define AUX_PKT_CONF_AVI_SCAN			(CMD_AUX_PKT_OFFSET + 0x0f)
#define AUX_PKT_GET_AVI_SCAN			(CMD_AUX_PKT_OFFSET + 0x10)
#define AUX_PKT_CLR_AVI					(CMD_AUX_PKT_OFFSET + 0x11)
#define AUX_PKT_GET_HDR_ST				(CMD_AUX_PKT_OFFSET + 0x12)
#define AUX_PKT_GET_AMDV_ST				(CMD_AUX_PKT_OFFSET + 0x13)
#define AUX_PKT_GET_HDR10P_ST			(CMD_AUX_PKT_OFFSET + 0x14)
#define AUX_PKT_GET_CUVA_ST				(CMD_AUX_PKT_OFFSET + 0x15)
#define AUX_PKT_CLR_DV_VS10_SIG			(CMD_AUX_PKT_OFFSET + 0x16)
#define AUX_PKT_SET_VSIF1				(CMD_AUX_PKT_OFFSET + 0x17)
#define AUX_PKT_SET_VSIF2				(CMD_AUX_PKT_OFFSET + 0x18)
#define AUX_PKT_DIS_VSIF				(CMD_AUX_PKT_OFFSET + 0x19)
#define AUX_PKT_SET_DRM					(CMD_AUX_PKT_OFFSET + 0x1a)
#define AUX_PKT_SET_EMP					(CMD_AUX_PKT_OFFSET + 0x1b)
#define AUX_PKT_SET_EMP_SBTM			(CMD_AUX_PKT_OFFSET + 0x1c)
#define AUX_PKT_CONF_EMP_NUMBER			(CMD_AUX_PKT_OFFSET + 0x1d)
#define AUX_PKT_CONF_EMP_PHY_ADDR		(CMD_AUX_PKT_OFFSET + 0x1e)
...
struct hdmitx_hw_common {
	...
	int (*validate_mode)(struct hdmitx_hw_common *tx_hw, u32 vic, u32 max_refreshrate);
