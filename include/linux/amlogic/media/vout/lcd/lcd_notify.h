...
#define LCD_EVENT_MDSW_LIMIT_ON          \
	(LCD_EVENT_MDSW_POWER_ON | LCD_EVENT_BL_ON | LCD_EVENT_SCREEN_RESTORE)
#define LCD_EVENT_MDSW_LIMIT_OFF         \
	(LCD_EVENT_SCREEN_BLACK | LCD_EVENT_BL_OFF | LCD_EVENT_MDSW_POWER_OFF)
#define LCD_EVENT_MDSW_MIN_ON          \
	(LCD_EVENT_MDSW_DATA_ON | LCD_EVENT_SCREEN_RESTORE)
#define LCD_EVENT_MDSW_MIN_OFF         \
	(LCD_EVENT_SCREEN_BLACK | LCD_EVENT_MDSW_DATA_OFF)
