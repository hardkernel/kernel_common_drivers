...
#define LCD_PRIORITY_UFR_POWER_IF_OFF  5
#define LCD_PRIORITY_UFR_POWER_IF_ON   2
#define LCD_PRIORITY_UFR_SWITCH_MODE   2
...
#define LCD_EVENT_UFR_POWER_ON         BIT(8)
#define LCD_EVENT_UFR_POWER_OFF        BIT(9)
#define LCD_EVENT_UFR_SWITCH_ON        BIT(10)
#define LCD_EVENT_UFR_SWITCH_OFF       BIT(11)

/* combined event */
#define LCD_EVENT_UFR_IF_POWER_ON          \
	(LCD_EVENT_UFR_POWER_ON | LCD_EVENT_BL_ON | LCD_EVENT_SCREEN_RESTORE)
#define LCD_EVENT_UFR_IF_POWER_OFF         \
	(LCD_EVENT_SCREEN_BLACK | LCD_EVENT_BL_OFF | LCD_EVENT_UFR_POWER_OFF)
